...
Your program **does** have:
  1. A different problem to solve than Assignment 1 (not just something you would see in math class this time around).  Since this will be a multi-screen program, you can solve different problems on each screen.
