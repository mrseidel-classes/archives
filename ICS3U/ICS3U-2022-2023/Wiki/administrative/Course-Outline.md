...
#### Final evaluation
Based on the work completed during the term, students will complete culminating tasks that allow the students to demonstrate their understanding which is typically a portfolio of their work which includes: their programming, non-programming knowledge, and reflection questions (30%).  
