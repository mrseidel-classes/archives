...
* You are required to include:
  * **At least one** of: _Inheritance_, _Interfaces_, or _Abstract Classes_
  * _Polymorphism_.
...
* Update your documentation as follows:
  * User manual should have headings and some information in 50% of the sections (like what the program is, etc.).
  * Your flowchart should now be a [**detailed flowchart**](https://github.com/mrseidel-classes/ICS3U/wiki/Flowcharting-Notes).  This will update again later.
